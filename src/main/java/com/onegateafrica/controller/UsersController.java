...
public class UsersController {
  ...
  @GetMapping("/check_if_profile_isregistrated/{number}")
  public Users check(@PathVariable(value = "number") String number ) {

    if (usersRepository.findByEmail(number).isPresent()){
      return usersRepository.findByEmail(number).get();
    }
    else return null;
  }
